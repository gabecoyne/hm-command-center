    ...
    <div>
      ...
      <div id="queue" class="grid gap-3 max-w-[1000px]">
        ${items.length ? html`
          ...
          </div>` : html`<div class="rounded-xl border border-edge bg-panel p-10 text-center text-slate-400">Nothing needs your response${who !== 'all' ? ' for ' + who : ''}. ✓</div>`}
      </div>
